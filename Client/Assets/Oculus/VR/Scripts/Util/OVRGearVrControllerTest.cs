...
public class OVRGearVrControllerTest : MonoBehaviour
{
	...
	void Start()
	{
		...
		monitors = new List<BoolMonitor>()
		{
            ...
            new BoolMonitor("RIndexTrigger",                    () => OVRInput.Get(OVRInput.RawButton.RIndexTrigger)),
            new BoolMonitor("RIndexTriggerDown",                () => OVRInput.GetDown(OVRInput.RawButton.RIndexTrigger)),
